package com.mick.common.utils;

import com.google.gson.Gson;
import com.mick.common.exception.TaoshuUploadException;
...
public class QiniuUtil {
    ...
    public static String qiniuUpload(String filePath){
        ...
        try {
            ...
            try {
                ...
                throw new TaoshuUploadException(e.toString());
            }
        }
    }
    ...
    private static String base64Data(String data){
     ...
     * @return
     */
    private static String renamePic(String fileName){
