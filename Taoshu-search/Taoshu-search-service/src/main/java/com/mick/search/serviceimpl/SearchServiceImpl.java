...
public class SearchServiceImpl implements SearchServiceint {
    ...
    @Override
    public SearchResult search(String key, int page, int size) {
        ...
        try {
            ...
            QueryBuilder qb = QueryBuilders.wildcardQuery("p_name","*"+key+"*");
...
//            QueryBuilder qb =  QueryBuilders.matchPhraseQuery("p_name",key);
            ...
            searchResponse = client.prepareSearch(ITEM_INDEX)
                    ...
                    .setQuery(QueryBuilders.multiMatchQuery(key,"pName","pIntro"))    // Query
...
//                    result.setTotalPages(totalPage);
            ...
            result.setTotalPages((int)(hits.totalHits/size)+1);
