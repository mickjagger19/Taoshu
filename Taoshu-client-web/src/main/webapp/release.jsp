    ...
    <div id="globa">
        <div id="top">
            <form id="keywordsform" action="${pageContext.request.contextPath }/index/searchResult" method="post">
                ...
                <div id="fourlist">
                    <a href="${pageContext.request.contextPath }/user/shoppingCar">购物车</a>&nbsp;&nbsp; <a href="${pageContext.request.contextPath }/user/myInformation?u_id=${user.uId}&user_name=${user.uName}">我的关注</a>&nbsp;&nbsp; <a href="${pageContext.request.contextPath }/register.jsp">注册</a>&nbsp;&nbsp;
                    <a href="${pageContext.request.contextPath }/login.jsp">登录</a>&nbsp;&nbsp; <a href="${pageContext.request.contextPath }/user/sendmessage">留言</a>
                </div>
            </form>
        </div>
        ...
        <div id="middle" style="margin:0 auto;width:100%">

            <div id="center" style="margin:0 auto;width:100%;height:600px">
                <div class="forms">
                <form id="bookform" action="${pageContext.request.contextPath }/user/submit" method="post">
                    <div id="clearboth"></div>
                    <div class="row">
                        <div id="name" class="form-group has-success has-feedback">
                            <div class="col-lg-8 col-lg-offset-2">
                                <input name="pName" class="form-control" style="height:40px;" value="" type="text" placeholder="书名">
                                <span class="form-control-feedback"></span>
                                <label class=" control-label"></label>
                            </div>
                        </div>
                        <div id="oriprice" class="form-group has-success has-feedback">
                            <div class="col-lg-8 col-lg-offset-2">
                                <input id="pOriprice" name="pOriprice" class="form-control" style="height:40px;" value="" type="text" placeholder="原价">
                                <span class="form-control-feedback"></span> <label class=" control-label"></label>
                            </div>
                        </div>
                        <div id="price" class="form-group has-success has-feedback">
                            <div class="col-lg-8 col-lg-offset-2">
                                <input id="pPrice" name="pPrice" class="form-control" style="height:40px;" value="" type="text" placeholder="出售价">
                                <span class="form-control-feedback"></span> <label class=" control-label"></label>
                            </div>
                        </div>
                        <div id="category" class="form-group has-success has-feedback">
                            <div class="col-lg-8 col-lg-offset-2">
                                <input name="pCategory" class="form-control" style="height:40px;" value="" type="text" placeholder="类别">
                                <span class="form-control-feedback"></span> <label class=" control-label"></label>
                            </div>
                        </div>
                        <div id="intro" class="form-group has-success has-feedback">
                            <div class="col-lg-8 col-lg-offset-2">
                                <input name="pIntro" class="form-control" style="height:40px;" value="" type="text" placeholder="内容介绍">
                                <span class="form-control-feedback"></span> <label class=" control-label"></label>
                            </div>
                        </div>
                        <div id="picture" class="form-group has-success has-feedback">
                            <div class="col-lg-8 col-lg-offset-2">
                                <input name="pPicture" class="form-control" style="height:40px;" value="" type="text" placeholder="图片(限url)">
                                <span class="form-control-feedback"></span> <label class=" control-label"></label>
                            </div>
                        </div>
                    </div>
                    <div class="row" style="text-align: center">
                        <br>
                        <div id="butt">
                            <button class="btn btn-danger" type="button" value="提交" onclick="releaseBook()">
                                发布！
                            </button>
                        </div>
                    </div>
